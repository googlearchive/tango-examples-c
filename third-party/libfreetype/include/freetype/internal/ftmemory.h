...
#define FT_MEM_REALLOC(ptr, cursz, newsz) \
  FT_ASSIGNP_INNER(ptr,                   \
                   ft_mem_realloc(memory, 1, (cursz), (newsz), (ptr), &error))
...
#define FT_MEM_REALLOC_MULT(ptr, oldcnt, newcnt, itmsz) \
  FT_ASSIGNP_INNER(                                     \
      ptr, ft_mem_realloc(memory, (itmsz), (oldcnt), (newcnt), (ptr), &error))
...
#define FT_MEM_QNEW_ARRAY(ptr, count) \
  FT_ASSIGNP_INNER(                   \
      ptr, ft_mem_qrealloc(memory, sizeof(*(ptr)), 0, (count), NULL, &error))
