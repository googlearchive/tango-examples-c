...
#ifndef TANGO_VIDEO_STABILIZATION_VIDEO_STABILIZATION_APP_H_
#define TANGO_VIDEO_STABILIZATION_VIDEO_STABILIZATION_APP_H_
...
#endif  // TANGO_VIDEO_STABILIZATION_VIDEO_STABILIZATION_APP_H_
