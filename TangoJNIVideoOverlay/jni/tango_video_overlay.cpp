...
bool SetupGraphics(int w, int h){
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, kTexWidth, kTexHeight, 0, GL_RGBA, GL_UNSIGNED_BYTE, 0);
    ...
    glVertexAttribPointer(attrib_vertices, 3, GL_FLOAT, GL_FALSE, 0, (const void*) 0);
    glBindBuffer(GL_ARRAY_BUFFER, 0);
    ...
    glVertexAttribPointer(attrib_textureCoords, 2, GL_FLOAT, GL_FALSE, 0, (const void*) 0);
    glBindBuffer(GL_ARRAY_BUFFER, 0);
...
{
#endif
    JNIEXPORT void JNICALL Java_com_google_tango_tangojnivideooverlay_TangoJNINative_init(JNIEnv * env, jobject obj,  jint width, jint height)
    {
        SetupTango();
        SetupGraphics(width, height);
    }
    
    JNIEXPORT void JNICALL Java_com_google_tango_tangojnivideooverlay_TangoJNINative_render(JNIEnv * env, jobject obj)
    {
        RenderFrame();
    }
#ifdef __cplusplus
