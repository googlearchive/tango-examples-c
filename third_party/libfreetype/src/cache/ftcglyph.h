...
#ifndef FTC_INLINE
FT_LOCAL(FT_Error)
FTC_GCache_Lookup(FTC_GCache cache, FT_UInt32 hash, FT_UInt gindex,
...
#define FTC_GCACHE_LOOKUP_CMP(cache, famcmp, nodecmp, hash, gindex, query, \
                              node, error)                                 \
  FT_BEGIN_STMNT FTC_GCache _gcache = FTC_GCACHE(cache);                   \
...
#define FTC_GCACHE_LOOKUP_CMP(cache, famcmp, nodecmp, hash, gindex, query,  \
                              node, error)                                  \
  FT_BEGIN_STMNT error = FTC_GCache_Lookup(FTC_GCACHE(cache), hash, gindex, \
