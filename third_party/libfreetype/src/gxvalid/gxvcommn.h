...
typedef void (*GXV_Validate_Func)(FT_Bytes table, FT_Bytes limit,
                                  GXV_Validator valid);
...
typedef GXV_LookupValueDesc (*GXV_Lookup_Fmt4_Transit_Func)(
    FT_UShort relative_gindex, GXV_LookupValueCPtr base_value_p,
...
typedef void (*GXV_StateTable_Subtable_Setup_Func)(
    FT_UShort table_size, FT_UShort classTable, FT_UShort stateArray,
...
typedef void (*GXV_StateTable_Entry_Validate_Func)(
    FT_Byte state, FT_UShort flags,
    GXV_StateTable_GlyphOffsetCPtr glyphOffset_p, FT_Bytes statetable_table,
    FT_Bytes statetable_limit, GXV_Validator valid);

typedef void (*GXV_StateTable_OptData_Load_Func)(FT_Bytes table, FT_Bytes limit,
                                                 GXV_Validator valid);
...
typedef void (*GXV_XStateTable_Subtable_Setup_Func)(
    FT_ULong table_size, FT_ULong classTable, FT_ULong stateArray,
...
typedef void (*GXV_XStateTable_Entry_Validate_Func)(
    FT_UShort state, FT_UShort flags,
    GXV_StateTable_GlyphOffsetCPtr glyphOffset_p, FT_Bytes xstatetable_table,
    FT_Bytes xstatetable_limit, GXV_Validator valid);
...
#define GXV_LIMIT_CHECK(_count)                                         \
  FT_BEGIN_STMNT if (p + _count > (limit ? limit : valid->root->limit)) \
...
#define GXV_NAME_ENTER(name)                   \
  FT_BEGIN_STMNT valid->debug_indent += 2;     \
...
#define GXV_TRACE(s)                                          \
  FT_BEGIN_STMNT FT_TRACE4(("%*.s", valid->debug_indent, 0)); \
  FT_TRACE4(s);                                               \
  FT_END_STMNT
...
FT_LOCAL(void)
gxv_BinSrchHeader_validate(FT_Bytes p, FT_Bytes limit, FT_UShort* unitSize_p,
                           FT_UShort* nUnits_p, GXV_Validator valid);
...
FT_LOCAL(void)
gxv_sfntName_validate(FT_UShort name_index, FT_UShort min_index,
                      FT_UShort max_index, GXV_Validator valid);
...
FT_LOCAL(void)
gxv_StateTable_subtable_setup(FT_UShort table_size, FT_UShort classTable,
                              FT_UShort stateArray, FT_UShort entryTable,
...
FT_LOCAL(void)
gxv_XStateTable_subtable_setup(FT_ULong table_size, FT_ULong classTable,
                               FT_ULong stateArray, FT_ULong entryTable,
...
FT_LOCAL(void)
gxv_array_getlimits_byte(FT_Bytes table, FT_Bytes limit, FT_Byte* min,
                         FT_Byte* max, GXV_Validator valid);

FT_LOCAL(void)
gxv_array_getlimits_ushort(FT_Bytes table, FT_Bytes limit, FT_UShort* min,
                           FT_UShort* max, GXV_Validator valid);

FT_LOCAL(void)
gxv_set_length_by_ushort_offset(FT_UShort* offset, FT_UShort** length,
                                FT_UShort* buff, FT_UInt nmemb, FT_UShort limit,
                                GXV_Validator valid);

FT_LOCAL(void)
gxv_set_length_by_ulong_offset(FT_ULong* offset, FT_ULong** length,
                               FT_ULong* buff, FT_UInt nmemb, FT_ULong limit,
                               GXV_Validator valid);

#define GXV_SUBTABLE_OFFSET_CHECK(_offset)                                  \
  FT_BEGIN_STMNT if ((_offset) > valid->subtable_length) FT_INVALID_OFFSET; \
  FT_END_STMNT

#define GXV_SUBTABLE_LIMIT_CHECK(_count)                           \
  FT_BEGIN_STMNT if ((p + (_count) - valid->subtable_start) >      \
                     valid->subtable_length) FT_INVALID_TOO_SHORT; \
  FT_END_STMNT
...
FT_LOCAL(void)
gxv_odtect_add_range(FT_Bytes start, FT_ULong length, const FT_String* name,
