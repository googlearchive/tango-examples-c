...
#define FT_DEFINE_CMAP_CLASS(class_, size_, init_, done_, char_index_,       \
                             ...
                             variant_list_, charvariant_list_,               \
                             variantchar_list_)                              \
  FT_CALLBACK_TABLE_DEF const FT_CMap_ClassRec class_ = {                    \
...
#define FT_DEFINE_GLYPH(class_, size_, format_, init_, done_, copy_, \
  ...
  FT_CALLBACK_TABLE_DEF const FT_Glyph_Class class_ = {              \
...
#define FT_DEFINE_RENDERER(class_, flags_, size_, name_, version_, requires_, \
  ...
  FT_CALLBACK_TABLE_DEF const FT_Renderer_Class                               \
      class_ = {FT_DEFINE_ROOT_MODULE(flags_, size_, name_, version_,         \
                                      requires_, interface_, init_, done_,    \
...
#define FT_DEFINE_RENDERER(class_, flags_, size_, name_, version_, requires_,  \
  ...
  FT_Error FT_Create_Class_##class_(FT_Library library,                        \
    ...
    FT_DEFINE_ROOT_MODULE(flags_, size_, name_, version_, requires_,           \
                          interface_, init_, done_,                            \
                          get_interface_) clazz->glyph_format = glyph_format_; \
                                                                               \
...
#define FT_DECLARE_MODULE(class_) \
  FT_CALLBACK_TABLE const FT_Module_Class class_;

#define FT_DEFINE_ROOT_MODULE(flags_, size_, name_, version_, requires_, \
                              interface_, init_, done_, get_interface_)  \
  {                                                                      \
    flags_, size_, name_, version_, requires_, interface_, init_, done_, \
        get_interface_,                                                  \
  }                                                                      \
  ,
...
#define FT_DEFINE_MODULE(class_, flags_, size_, name_, version_, requires_, \
                         interface_, init_, done_, get_interface_)          \
  FT_CALLBACK_TABLE_DEF const FT_Module_Class                               \
      class_ = {flags_,     size_, name_, version_,       requires_,        \
                interface_, init_, done_, get_interface_, };
