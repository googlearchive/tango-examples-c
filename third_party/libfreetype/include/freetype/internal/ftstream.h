...
#define FT_PEEK_LONG(p)                                    \
  FT_INT32(FT_INT8_I32(p, 0, 24) | FT_BYTE_I32(p, 1, 16) | \
           FT_BYTE_I32(p, 2, 8) | FT_BYTE_I32(p, 3, 0))
...
#define FT_PEEK_LONG_LE(p)                                 \
  FT_INT32(FT_INT8_I32(p, 3, 24) | FT_BYTE_I32(p, 2, 16) | \
           FT_BYTE_I32(p, 1, 8) | FT_BYTE_I32(p, 0, 0))
...
#define FT_READ_SHORT_LE(var) \
  FT_READ_MACRO(FT_Stream_ReadShortLE, FT_Short, var)
#define FT_READ_USHORT_LE(var) \
  FT_READ_MACRO(FT_Stream_ReadShortLE, FT_UShort, var)
