...
Java_com_projecttango_experiments_nativehellotango_TangoJNINative_checkTangoVersion(
    JNIEnv* env, jobject, jobject activity, jint min_tango_version) {
  return tango_handler.CheckTangoVersion(env, activity, min_tango_version);
}
...
Java_com_projecttango_experiments_nativehellotango_TangoJNINative_connect(
    JNIEnv*, jobject) {
  return static_cast<jboolean>(tango_handler.ConnectService());
}
