...
bool TangoHandler::CheckTangoVersion(JNIEnv* env, jobject activity,
...
bool TangoHandler::ConnectService() {
  return TangoService_connect(nullptr, tango_config_) == TANGO_SUCCESS;
}
