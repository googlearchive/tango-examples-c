...
/**
 * Util provides utility functions for accessing Project Tango permissions.
 */
public class Util {

    // Checks if the calling app has the specified permission.  It is recommended
    // that an app check if it has a permission before trying to request it; this
    // will save time by avoiding re-requesting permissions that have already been
    // granted.
    //
