...
extern "C" {
#endif
JNIEXPORT void JNICALL Java_com_projecttango_videooverlaynative_TangoJNINative_OnCreate(
...
JNIEXPORT void JNICALL Java_com_projecttango_videooverlaynative_TangoJNINative_OnResume(
    JNIEnv* env, jobject obj) {
...
JNIEXPORT void JNICALL Java_com_projecttango_videooverlaynative_TangoJNINative_OnPause(
    JNIEnv* env, jobject obj) {
...
JNIEXPORT void JNICALL Java_com_projecttango_videooverlaynative_TangoJNINative_OnDestroy(
    JNIEnv* env, jobject obj) {
  delete cam;
  delete axis;
}

JNIEXPORT void JNICALL Java_com_projecttango_videooverlaynative_TangoJNINative_SetupGraphic(
