...
static const GLfloat kVertices[] = {-0.5, 0.5, 0.0, -0.5, -0.5, 0.0,
...
VideoOverlay::VideoOverlay() {
  ...
  attrib_vertices = glGetAttribLocation(shader_program_, "vertex");
  glBindBuffer(GL_ARRAY_BUFFER, vertex_buffers[0]);
  glEnableVertexAttribArray(attrib_vertices);
  glVertexAttribPointer(attrib_vertices, 3, GL_FLOAT, GL_FALSE, 0, nullptr);
  glBindBuffer(GL_ARRAY_BUFFER, 0);
...
VideoOverlay::~VideoOverlay() { glDeleteShader(shader_program_); }

void VideoOverlay::Render() const {
